...
exports.createOrderValidation = [
    ...
    express_validator_1.body("itemsPrice").notEmpty().withMessage("Items Price required."),
    express_validator_1.body("vatPrice").notEmpty().withMessage("VAT Price required."),
    express_validator_1.body("shippingPrice").notEmpty().withMessage("Shipping Price required."),
    express_validator_1.body("totalPrice").notEmpty().withMessage("Total Price required."),
    express_validator_1.body("shippingAddress.email").notEmpty().withMessage("Name required."),
